    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=255, unique=True, verbose_name='Email de registro')),
                ('seudonimo', models.CharField(blank=True, help_text='Nombre público en el foro, opcional.', max_length=150, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('humor', models.IntegerField(choices=[(1, 'Muy Mal'), (2, 'Mal'), (3, 'Neutral'), (4, 'Bien'), (5, 'Muy Bien')], default=3, help_text='Nivel de autopercepción emocional (1 a 5).')),
