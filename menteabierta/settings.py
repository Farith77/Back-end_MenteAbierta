"""
Django settings for menteabierta project.
...
SECRET_KEY = 'django-insecure-yo22#9k12u+a$9dhfr#f@7zz*zs764n$t9c-6b3fc$@+v1ombe'
...
ROOT_URLCONF = 'menteabierta.urls'
...
WSGI_APPLICATION = 'menteabierta.wsgi.application'
